      ...
      <div className="container closing-inner">
        <Reveal variant="up" className="closing-copy">
          ...
          <p className="closing-statement">
            Gagasan kami adalah garis demarkasi perjuangan. Mari kembalikan
            muruah BEM UAP pada porsinya yang sejati — ini bukan sekadar tentang
            memenangkan kursi, ini tentang memenangkan masa depan kampus kita.
          </p>
        </Reveal>
        ...
        <Reveal variant="up" delay={0.2} className="closing-download-card">
          ...
          <div className="download-card-info">
            ...
            <p className="download-card-meta">
              BEM UAP 2026 · Husein Fadhilah &amp; Tomi Syahirza · PDF
            </p>
          </div>
          <a
            href="/Visi Misi.pdf"
